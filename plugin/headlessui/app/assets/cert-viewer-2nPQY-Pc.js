import{a as e}from"./index-CxhbKLM3.js";import{CertService as t}from"./cert-DoRQLZ3Z.js";function n({mod:n,certData:r,issuances:i,courseId:a}){let o=Array.isArray(i)&&i.length>0,s=document.createElement(`div`);s.className=`cert-viewer`,s.style.cssText=`
    display: flex;
