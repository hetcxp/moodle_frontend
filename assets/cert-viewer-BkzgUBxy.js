import{CertService as e}from"./cert-CXpThgIV.js";function t({mod:t,certData:n,issuances:r,courseId:i}){let a=Array.isArray(r)&&r.length>0,o=document.createElement(`div`);o.className=`cert-viewer`,o.style.cssText=`
    display: flex;
